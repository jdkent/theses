...
Moreoever, Ogawa et al. found the BOLD contrast in
...
typically recieve inputs and/or locally process information within a similar time frame.
...
the excitment has outpaced the investigations of the methods to understand brain organization.
...
For tasks where events in one condition all occur together and are temporally seperable
...
If different cogntive processes where occuring in close proximity such as visually encoding
...
While LSS addresses the immediate problem of high colinearity between regressors,
...
univeriate correlation differences.
...
Finally, previous work used different quantative measures
...
1) whether BSC methods or PPI analysis are more senstive
...
\begin{figure}[H]
  ...
  \caption{
    ...
    to represent the theoretical neuronal timecourse.
...
Future work should attempt to replicate our findings in an independent dataset.
