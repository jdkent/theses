...
(FIgure~\ref{fig:positive_bias}) agrees with previous work looking at
...
matching the decreased context-dependent functional connectivity found in the Schaefer atlas as well~\ref{fig:positive_bias_schaefer}.
...
contrast, only PPI analyses had marginally more results than expected by chance alone in the activation atlas.
...
(Figures ~\ref{fig:positive_bias} \& ~\ref{fig:positive_bias_schaefer}).
A common interpretation would be that a decreased correlation between two ROIs reflects less information
sharing between the two ROIs, that an increasing correlation reflects greater information transfer~\cite{Gonzalez-Castillo2018}.
...
The current thesis largely corraborates and extends the work by Ito et al. (2019),
...
BSC can theoretically model a facorial design by treating all combinations of the factors
