...
PBSC methods and PPI analyses have been compared previously~\cite{Cisler2012,Di2019}.
...
4) up-sampling of both the deconvoled ROI time series and psychological variable,
...
events.
The deconvolution of the BOLD signal used in PPI analyis
...
The reason for this discrepency was because of how the simulated
...
the correlation between LSS and PPI breaks down in certain scenerios.
...
interpetable when calculating network measures.
